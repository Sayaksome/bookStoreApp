        ...
        <div className="order-2 md:order-1 w-full md:w-[50%] mt-12  md:mt-32">
          <div className="space-y-12">
            ...
            <p className="text-xl">
              ...
              molestias tempore nulla sapiente temporibus nobis hic accusamus,
              repudiandae facilis alias, necessitatibus magni adipisci fugiat
              qui tenetur eius esse nesciunt eaque.
            </p>

            <label className="position-relative z-100 input validator">
              <svg
